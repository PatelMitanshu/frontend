...
const Sector = () => {
  ...
  useEffect(() => {
    const schemes_backend_url =
      "https://backend-wq9h.onrender.com/api/v1/users/scheme-get";
  ...
  const schemedata = () => {
    return schemes
      .filter((scheme) => scheme.sector === message)
      .map((scheme) => {
        return (
          <button
      ...
      <div className="sector_container">
        ...
        <div className="scheme_data">
          ...
          <div className="scheme_list">
            <form action="https://www.google.com/search" method="get"  className="search-bar" traget="_blank">
                <input
                 type="text"
